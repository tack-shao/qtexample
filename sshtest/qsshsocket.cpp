...
static const mode_tt2 S_ISUID      = 0x08000000;           ///< does nothing
static const mode_tt2 S_ISGID      = 0x04000000;           ///< does nothing
static const mode_tt2 S_ISVTX      = 0x02000000;           ///< does nothing
//static const mode_tt2 S_IRUSR      = mode_tt2(_S_IREAD);     ///< read by user
//static const mode_tt2 S_IWUSR      = mode_tt2(_S_IWRITE);    ///< write by user
//static const mode_tt2 S_IXUSR      = 0x00400000;           ///< does nothing
#   ifndef STRICT_UGO_PERMISSIONS
//static const mode_tt2 S_IRGRP      = mode_tt2(_S_IREAD);     ///< read by *USER*
//static const mode_tt2 S_IWGRP      = mode_tt2(_S_IWRITE);    ///< write by *USER*
//static const mode_tt2 S_IXGRP      = 0x00080000;           ///< does nothing
//static const mode_tt2 S_IROTH      = mode_tt2(_S_IREAD);     ///< read by *USER*
//static const mode_tt2 S_IWOTH      = mode_tt2(_S_IWRITE);    ///< write by *USER*
//static const mode_tt2 S_IXOTH      = 0x00010000;           ///< does nothing
#   else
static const mode_tt2 S_IRGRP      = 0x00200000;           ///< does nothing
static const mode_tt2 S_IWGRP      = 0x00100000;           ///< does nothing
static const mode_tt2 S_IXGRP      = 0x00080000;           ///< does nothing
static const mode_tt2 S_IROTH      = 0x00040000;           ///< does nothing
static const mode_tt2 S_IWOTH      = 0x00020000;           ///< does nothing
static const mode_tt2 S_IXOTH      = 0x00010000;           ///< does nothing
#   endif
static const mode_tt2 MS_MODE_MASK = 0x0000ffff;           ///< low word
#endif
...
//        qDebug() << "run" << endl;
        if (m_session == NULL)
        {
            ...
            if (m_host != "")
            {
                ...
                char host[128];
                snprintf(host, sizeof(host), "%s","192.168.59.132");
//                ssh_options_set(m_session, SSH_OPTIONS_HOST, m_host.toLocal8Bit().data());
                ...
                ssh_options_set(m_session, SSH_OPTIONS_LOG_VERBOSITY_STR, &verbosity);
                ssh_options_set(m_session, SSH_OPTIONS_PORT, &m_port);
//                ssh_options_set(m_session, SSH_OPTIONS_TIMEOUT_USEC, &m_timeout);
...
//                ssh_options_set(my_ssh_session, SSH_OPTIONS_PORT, &port);
                ...
                qDebug() << "connectionResponse" << ssh_get_error(m_session);
